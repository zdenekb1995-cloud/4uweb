...
const ServiceSlider = () => {
  return (
    <Swiper
      ...
      modules={[Pagination]}
      className="h-auto min-h-[240px] sm:h-[340px]"
      loop={false}
      watchOverflow
    >
      {serviceData.map((item, i) => (
        <SwiperSlide key={i}>
          <div className="bg-[rgba(65,47,123,0.15)] h-full min-h-[240px] rounded-lg px-6 py-8 flex flex-col group cursor-pointer hover:bg-[rgba(89,65,169,0.15)] transition-all duration-300">
